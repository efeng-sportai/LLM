...
from app.routers import health, api, training_data, sports, populate
...
# Include routers - Only training_data, sports, and populate routers (other collections removed)
